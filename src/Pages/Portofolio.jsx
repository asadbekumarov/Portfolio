    ...
    >
      ...
      >
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7]">
          ...
          >
            Portfolio ko'rgazmasi
          </span>
        </h2>
        <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2">
          Loyihalar, sertifikatlar va texnik tajribalar orqali mening
          sayohatimni o'rganing. Har bir bo'lim mening doimiy o'rganish
          yo'limdagi muhim bosqichni anglatadi. Loyihalar Sertifikatlar Tech
          Stack
        </p>
      </div>
