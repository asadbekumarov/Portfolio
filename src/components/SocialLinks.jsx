...
const socialLinks = [
  {
    ...
    subText: "Umaorv Asadbek",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/asadbek-u-298078344/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Umarov Asadbek",
    icon: Instagram,
    url: "https://www.instagram.com/umarov__asadbek_/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Umarov Asadbek",
    icon: Github,
    url: "https://github.com/asadbekumarov",
    color: "#ffffff",
